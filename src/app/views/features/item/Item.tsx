      ...
      {data && (
        <>
          <div className={classes.contentItem}>
            ...
            {type === 'brief' && data.meanings.length > 0 && (
              <MeaningItemView
                type={type}
                meaning={
                  data.meanings.find((item) => item.common) || data.meanings[0]
                }
          ...
          <div className={classes.date}>
            <span>
              {moment(data.created_date).format(defaultSetting.dateTimeFormat)}
            </span>
            <span>
              {moment(data.last_update).format(defaultSetting.dateTimeFormat)}
            </span>
          </div>
        </>
      )}
